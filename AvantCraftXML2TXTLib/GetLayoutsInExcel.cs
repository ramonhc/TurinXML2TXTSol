...
namespace AvantCraftXML2TXTLib
{
  class GetLayoutsInExcel
  {
    public void GetLayouts()
    {
      ...
      HB.Append("headerId,H1_05,H1_08,H1_11,H1_14,H1_30,H1_31,H1_32,H1_46,H1_50,H2_02,H2_03,H2_05,H2_06,H2_08,H2_09,H2_11,H2_12,H2_13,H2_14,H4_02,H4_03,H4_13,D_04,D_06,D_07,D_09,D_25,D_37,D_38,D_42,S_10,S_16,S_36,S_37,filename");
      foreach(TE_TXT_HEADER h in allhead)
      {
        HB.Append(h.headerId + "," + h.H1_05 + "," + h.H1_08 + "," + h.H1_11 + "," + h.H1_14 + "," + h.H1_30 + "," + h.H1_31 + "," + h.H1_32 + "," + h.H1_46 + "," + h.H1_50 + "," + h.H2_02 + "," + h.H2_03 + "," + h.H2_05 + "," + h.H2_06 + "," + h.H2_08 + "," + h.H2_09 + "," + h.H2_11 + "," + h.H2_12 + "," + h.H2_13 + "," + h.H2_14 + "," + h.H4_02 + "," + h.H4_03 + "," + h.H4_13 + "," + h.D_04 + "," + h.D_06 + "," + h.D_07 + "," + h.D_09 + "," + h.D_25 + "," + h.D_37 + "," + h.D_38 + "," + h.D_42 + "," + h.S_10 + "," + h.S_16 + "," + h.S_36 + "," + h.S_37 + "," + h.filename + Environment.NewLine);
      }
     ...
     TextWriter sw = new StreamWriter(Utils.GetFinalDestination("default") + "concentrado" + ".csv", false, Encoding.GetEncoding(1252), 512);
